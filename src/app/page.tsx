      ...
      <main className="flex-1">
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tighter text-primary font-headline sm:text-5xl xl:text-6xl/none">
              ...
              <div className="relative animate-fade-in-up [animation-delay:200ms]">
                {heroImage && (
                  <Image
                    ...
                    className="mx-auto aspect-video overflow-hidden rounded-2xl object-cover sm:w-full shadow-2xl"
                  />
                )}
              </div>
            </div>
        ...
        <section id="features" className="w-full bg-muted/40 py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-stretch gap-6 py-12 sm:grid-cols-2 md:gap-8 lg:max-w-none lg:grid-cols-4">
              {features.map((feature, index) => (
                <div key={index} className="animate-fade-in-up" style={{animationDelay: `${index * 150}ms`}}>
                  <Card className="h-full transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/10">
                    <CardHeader className="items-center p-6">
                      {feature.icon}
                      <CardTitle className="mt-4 text-center font-headline text-lg">{feature.title}</CardTitle>
                    </CardHeader>
